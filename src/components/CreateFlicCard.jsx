...
class CreateFlicCard extends Component {
    ...
    uploadVideo = (e) => {
        ...
        const config = {
            ...
            headers: {
                "Flic-Token": this.props.user.token,
            },
        };
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="ml-3 flex-1">
                            <p className="text-sm font-medium text-gray-900">
                                Your video was posted, {this.props.user.username}!
                            </p>
                            <p className="mt-1 text-sm text-gray-500">
                                {this.state.postedCaptionText}
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    this.setState(
                        {
                            ...
                            hash: null,
                            waitingForPostCreation: false,
                            postedCaptionText: this.state.captionText,
                            captionText: "",
                            videoLink: videoLink
                        },
                        () => {
                    ...
                    <form className='flic-data-input' onSubmit={(e) => this.handleFormSubmit(e)}>
                        <div className={"avatar-and-caption"}>
                            <div className='avatar-container'>
                                <img className='avatar' src={this.props.user.profile_picture_url}
    ...
    render() {
        return this.props.isUserLoggedIn? this.getLoggedInView() : this.getGuestView();
    }
}
...
export default connect(mapStateToProps)(CreateFlicCard);
